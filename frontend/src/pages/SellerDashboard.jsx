        ...
        <div className="dashboard-header-content">
          ...
          <div className="header-right">
            <div className="user-info">
              ...
              <div className="user-role">Waste Seller</div>
              {sellerLocation && sellerLocation.latitude && sellerLocation.longitude && (
                <div style={{fontSize: "11px", color: "#ffd700", marginTop: "4px", fontWeight: "500"}}>
                  📍 {sellerLocation.area_name || `${sellerLocation.latitude.toFixed(2)}, ${sellerLocation.longitude.toFixed(2)}`}
                </div>
              )}
            </div>
            ...
            <button onClick={() => setShowLocationPicker(true)} className="btn-secondary">
              📍 {sellerLocation ? "Update Location" : "Set Location"}
            </button>
